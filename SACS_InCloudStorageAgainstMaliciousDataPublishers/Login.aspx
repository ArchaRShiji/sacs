				...
				<div class="container">
					<div class="header-bar">
						<a href="index.html" class="branding">
							...
							<h1 class="site-title">SACKS in Cloud Computing</h1>
						</a>
						...
						<div class="main-navigation">
							...
							<ul class="menu">
								...
								<li class="menu-item current-menu-item"><a href="#contact">Login</a></li>
							</ul> <!-- .menu -->
						</div> <!-- .main-navigation -->
						...
						<form class="contact-form" runat="server">
							<div class="row">
								...
								<div class="col-md-6">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/log5.png" alt="" class="icon" height="350px" width="350px">
								...
								<div class="col-md-6">
									<br />
									<br />
									<div class="control"><asp:TextBox ID="TextBox1" runat="server" placeholder="Your Username..."></asp:TextBox><img src="images/icon-user.png" alt="" class="icon"></div>
									<br />	<br />
									<div class="control"><asp:TextBox ID="TextBox2" runat="server" placeholder="Your Password..."></asp:TextBox><img src="images/icon-globe.png" alt="" class="icon"></div>
								<p class="text-right">
